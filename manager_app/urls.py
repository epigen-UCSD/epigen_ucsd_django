...
urlpatterns = [
    ...
    path('servicerequest_update/<int:pk>/', views.ServiceRequestUpdateView,
         name='collab_servicerequest_update'),
    path('add_new_quote/<int:pk>/', views.ServiceRequestAddNewQuoteView,
         name='collab_servicerequest_add_new_quote'),
    path('servicerequests/', TemplateView.as_view(
        template_name="manager_app/servicerequests_list.html"), name='servicerequests_list'),
    path('servicerequests_list/', views.ServiceRequestDataView,
         name='service_request_display'),
    ...
    path('quote_upload/<slug:requestid>/<slug:quoteid>/',
         views.QuotePdfByQidUpload, name='quote_upload_qid'),
    path('quote_update/<slug:requestid>/<slug:quoteid>/',
         views.QuoteUpdateView, name='quote_update'),
    path('quote_delete/<slug:requestid>/<slug:quoteid>/',
         views.QuoteDeleteView, name='quote_delete'),
